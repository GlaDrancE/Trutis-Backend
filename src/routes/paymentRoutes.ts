...
paymentRoutes.post('/payments/create-products', createProducts as RequestHandler)
...
paymentRoutes.post("/webhook", bodyParser.raw({ type: 'application/json' }), webhook as RequestHandler)
