...
app.use(cors({
  origin: [process.env.CLIENT_URL as string, process.env.AGENT_URL as string, process.env.ADMIN_URL as string, process.env.FORMS_URL as string], // Allow frontend origin
